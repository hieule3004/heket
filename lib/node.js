...
class Node {
	...
	setIsOptional(is_optional = true) {
		this.is_optional = is_optional;
		return this;
	}

	setIsRepeating(is_repeating = true) {
	...
	toJSON() {
		var child_nodes = this.getChildNodes().map(function map(child_node) {
		...
		return {
			...
			quoted_string:    this.quoted_string,
			child_nodes:      child_nodes,
			has_alternatives: this.has_alternatives,
